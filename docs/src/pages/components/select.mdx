...
`breeze-select` functionality is similar to an HTML `select` element.
...
<ComponentPreview
  client:load
  component='
    <breeze-select label="Start of the week">
      <breeze-option value="monday" text="Monday" selected></breeze-option>
      <breeze-option value="tuesday" text="Tuesday"></breeze-option>
      <breeze-option value="wednesday" text="Wednesday"></breeze-option>
    </breeze-select>
  '
...
```html
 <breeze-select>
  ...
  <breeze-option value="tuesday" text="Tuesday"></breeze-option>
  <breeze-option value="wednesday" text="Wednesday"></breeze-option>
  <breeze-icon icon="chevron-down" slot="suffix"></breeze-icon>
</breeze-select>
```
