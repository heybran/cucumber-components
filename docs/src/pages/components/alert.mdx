...
<ComponentPreview
  client:load
  component='
    <breeze-button onclick="this.nextElementSibling.show();">Click to show alert</breeze-button>
    <breeze-alert>This is message of an alert component.</breeze-alert>
  '
/>
...
<ComponentPreview
  client:load
  component='
    <breeze-button onclick="this.nextElementSibling.show();">Click to show danger alert</breeze-button>
    <breeze-alert variant="danger">This is message of a danger alert component.</breeze-alert>
  '
/>
...
```html
<breeze-button onclick="this.nextElementSibling.show();">Click to show alert</breeze-button>
<breeze-alert variant="danger">This is message of an alert component.</breeze-alert>
```