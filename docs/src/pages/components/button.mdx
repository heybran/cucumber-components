...
<ComponentPreview
  client:load
  component='
    <cc-button variant="primary">Button</cc-button>
    <cc-button variant="success">Button</cc-button>
  '
/>
...
<ComponentPreview
  client:load
  component='
    <cc-button variant="text" size="small">Button</cc-button>
    <cc-button variant="text">Button</cc-button>
    <cc-button variant="text" size="large">Button</cc-button>
  '
/>
...
<cc-button variant="text" size="medium">Button</cc-button>
<cc-button variant="text" size="large">Button</cc-button>
```
