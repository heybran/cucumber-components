import{F as i}from"../assets/form-element-ad540cf6.js";import"../icon/icon.js";import"../assets/base-element-be430c97.js";customElements.define("cc-password-field",class extends i{get input(){return this.shadowRoot.querySelector("input")}set label(t){this.shadowRoot.querySelector('[part="label"] span').textContent=t}set placeholder(t){this.input.placeholder=t}set helperText(t){this.shadowRoot.querySelector('[part="helper-text"]').textContent=t}set readyonly(t){this.input.readOnly=t}set disabled(t){this.input.disabled=t,this.setAttribute("aria-disabled","true"),this.shadowRoot.querySelector('slot[name="suffix"]').firstElementChild?.setAttribute("tabindex","-1")}set pattern(t){this.input.pattern=t}get value(){return this.input.value}set value(t){this.input.value=t}set required(t){this.input.required=t}connectedCallback(){super.render(`<div part="container">
	<label part="label">
    <span></span>
  </label>
