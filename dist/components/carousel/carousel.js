import{B as n}from"../assets/base-element-be430c97.js";customElements.define("cc-carousel",class extends n{get itemsPerView(){let t=3;return this.getAttribute("items-per-view")&&(t=Number(this.getAttribute("items-per-view"))),t}get totalSlides(){return Math.ceil(this.carouselItems.length/this.itemsPerView)}connectedCallback(){super.render(`<div part="container">
	<div
