import{F as i}from"../assets/form-element-1a56e9b6.js";import"../icon/icon.js";import"../assets/base-element-f411db3f.js";customElements.get("cc-checkbox")||customElements.define("cc-checkbox",class extends i{set checked(t){this.input.checked=t,this.input.ariaChecked=t?"true":"false"}set disabled(t){this.input.disabled=t}set required(t){this.input.required=t}set value(t){this.input.value=t}get value(){return this.input.value}set name(t){this.input.name=t}set label(t){this.shadowRoot.querySelector('[part="label"] slot').textContent=t}connectedCallback(){super.render(`<label part="base">
  <input
		class="sr-only"
		type="checkbox"
		aria-busy="false"
